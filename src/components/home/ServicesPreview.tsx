              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                    <h3 className="font-display text-2xl md:text-3xl lg:text-4xl text-espresso tracking-wide uppercase transition-transform duration-700 ease-out group-hover:-translate-y-0.5">
                      {service.title}
                    </h3>
